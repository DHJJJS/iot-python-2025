...
- 개발환경 설정
    - 압축, 폰트, 개발용 에디터 설치
        - 반디집 설치(교육, 회사에 전부 무료)
        - 나눔글꼴 중 D2Coding. 추후 나눔고딕코딩체 설치 예정
        - NotePad++
...
- 프로그래밍 언어 종류
    - 컴파일러(실행파일 생성성) 
        - C, C++, C#, Java, ...
    vs 인터프리터(소스코드를 바로 실행, 실행파일 없음)
        - 파이썬, Javascript, ...
    
- 파이썬(Python)
    - 1990년에 개발한 인터프린터 언어
    - 네덜란드 개발자 귀도 반 로섬
    - 객체지향 프로그래밍 언어(Object Oriented Program) = 위의 모두 다
    - 아주 쉽게 학습할 수 있는 언어
...
- 파이썬 기초
    ...
    - 객체지향 다시
        - 모든 클래스의 고향은 object 클래스!
        - 클래스 작성방법
        - 속성(멤버변수)
        - 메서드(멤버함수)
        - 캡슐화 - 멤버변수 폐쇄화, __멤버변수
        - 상속 - 상위 클래스를 가지고 자식클래스 만드는 것
        - **추상화**
        - **인터페이스**
        - **다형성**
        - **SOLID 원칙**
...
https://github.com/user-attachments/assets/9b095b77-97f7-4680-8dda-c01bf6dd4201
...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt : 파이썬 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 GUI라이브러리를 Python용으로 변경
            - 화려한 UI구성
            - 코딩 다양성
            - 조금 어렵다(파이썬 코드와 분리가능)
...
https://github.com/user-attachments/assets/4493ae96-fc45-4509-b022-5d3ffd030132
