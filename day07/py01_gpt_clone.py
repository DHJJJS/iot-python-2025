...
genai.configure(api_key='AIzaSyDROYMU1jrrXyUndfMhVRuHrYI7vIw8i8E') # 신청한 API키 
...
# 12. 아이콘 변경
# ./image/ 경로는 삭제
root.iconbitmap('chatbot.ico') # pyinstaller때는 실행폴더에 icon 복사
...
# 11. 프로그램 종료 버튼(x)를 누르면 종료 메시지 확인 후 종료
