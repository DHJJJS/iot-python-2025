...
def main():
    ...
    while True:
        Surface.fill(color='black') # Surface.fill((0, 0, 255)) 
        ...
        for x in range(10, 400, 10):
            pygame.draw.line(Surface, 'white', (x, 0), (x, 400))
        for y in range(10, 400, 10):
            pygame.draw.line(Surface, 'white', (0, y), (400, y))

        
        # 선
        pygame.draw.line(Surface, color=(255,0,0), start_pos=(30, 30), end_pos=(150, 30), width=3)
        pygame.draw.line(Surface, (0,255,0), (30, 60), (150, 60), 5)
        pygame.draw.line(Surface, (0,0,255), (30, 90), (150, 150), 7)

        # 사각형
        pygame.draw.rect(Surface, color='white', rect=(200, 30, 50, 50))
        pygame.draw.rect(Surface, (255,0,0), (260, 30, 100, 50), 3)

        # 원(중심을 시작점으로)

        pygame.draw.circle(Surface, (255,255,0), (40, 180), 10)
        pygame.draw.circle(Surface, (255,255,255), (80, 180), 20)
        pygame.draw.circle(Surface, (255,112,20), (280, 160), 30, 10)

        # 타원
        pygame.draw.ellipse(Surface, color=(255,255,255), rect=(280, 180, 100, 50))
        pygame.draw.ellipse(Surface, (255,255,0), (280, 300, 100, 50), 10)
